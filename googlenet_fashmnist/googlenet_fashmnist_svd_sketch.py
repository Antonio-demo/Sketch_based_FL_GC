...
f1 = open('/home/user/tmp/GoogleNet_CIFAR10/googlenet_fashmnist/svd_sketch/google_fashmnist_svd_sketch_train_loss_acc.csv', 'w')
csv_writer1 = csv.writer(f1)

line1_1 = ['epoch', 'train loss', 'train acc', 'train time']
csv_writer1.writerow(line1_1)

f2 = open('/home/user/tmp/GoogleNet_CIFAR10/googlenet_fashmnist/svd_sketch/google_fashmnist_svd_sketch_test_loss_acc.csv', 'w')
...
# save model
torch.save(model.state_dict(), './goolenet_fashmnist_svd_sketch.pt')
