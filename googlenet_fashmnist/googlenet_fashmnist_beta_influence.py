...
f1 = open('/home/user/tmp/GoogleNet_CIFAR10/googlenet_fashmnist/beta_influence/google_fashmnist_beta_influence_train_loss_acc_1.csv', 'w')
csv_writer1 = csv.writer(f1)

line1_1 = ['beta', 'epoch', 'train loss', 'train acc', 'train time']
csv_writer1.writerow(line1_1)

f2 = open('/home/user/tmp/GoogleNet_CIFAR10/googlenet_fashmnist/beta_influence/google_fashmnist_beta_influence_test_loss_acc_1.csv', 'w')
...
# save model
torch.save(model.state_dict(), './goolenet_cifar_beta_influence.pt')
