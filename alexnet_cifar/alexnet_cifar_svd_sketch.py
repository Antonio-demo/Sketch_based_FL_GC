...
f1 = open('/home/user/tmp/GoogleNet_CIFAR10/alexnet_cifar/svd_sketch/alex_cifar_svd_sketch_train_loss_acc.csv', 'w')
...
f2 = open('/home/user/tmp/GoogleNet_CIFAR10/alexnet_cifar/svd_sketch/alex_cifar_svd_sketch_test_loss_acc.csv', 'w')
...
# save model
torch.save(model.state_dict(), './alexnet_cifar_svd_sketch.pt')
