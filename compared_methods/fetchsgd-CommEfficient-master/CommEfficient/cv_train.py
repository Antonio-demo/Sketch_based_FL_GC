...
from fetchsgd_utils import make_logdir, union, Timer, TableLogger, parse_args
from fetchsgd_utils import PiecewiseLinear, Exp, num_classes_of_dataset, steps_per_epoch
...
def compute_loss_mixup(model, batch, args):
	...
	inputs, targets_a, targets_b, lam = mixup_data(images, targets, args.mixup_alpha,use_cuda="cuda" in args.device)
