...
# 	desktop_path = "E:\Cryption\Federal Learning\FLCodes\smallNet-on-CIFAR10-master"
# 	# 新创建的txt文件的存放路径
...
if __name__ == '__main__':
	...
	alpha = 0.1
	stack_x1_again = x_svd + alpha * stack_x1_again
	...
	# filename = 'cnn_cifar_svd_sketch_error'
	# text_create(filename)
	# output = sys.stdout
	# outputfile = open(
	# 	"E:\Cryption\Federal Learning\FLCodes\smallNet-on-CIFAR10-master\\" + filename + '.txt', 'w')
	...
	for epoch in range(EPOCH):
		...
		#print('Round {:3d}, Train Loss {:.3f}, Train Acc {:.2f}, Test Loss {:.3f}, Test Acc {:.2f}'.
		      #format(epoch + 1, train_loss, train_accuracy, test_loss, test_accuracy))
