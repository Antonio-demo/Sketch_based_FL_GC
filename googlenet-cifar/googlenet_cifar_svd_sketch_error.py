...
tensor_x_1 = tensor_x + alpha * error_accumulate #64*48
...
f1 = open('/home/user/tmp/GoogleNet_CIFAR10/svd_sketch_error/google_cifar_svd_sketch_error_train_loss_acc.csv', 'w')
...
f2 = open('/home/user/tmp/GoogleNet_CIFAR10/svd_sketch_error/google_cifar_svd_sketch_error_test_loss_acc.csv', 'w')
...
for epoch in range(num_epochs):
	...
	line1 = [epoch + 1, loss.item(), train_acc, round(float(train_time), 4)]
...
# save model
torch.save(model.state_dict(), './goolenet_cifar_svd_sketch_error.pt')
