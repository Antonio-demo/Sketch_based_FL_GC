...
f1 = open('/home/user/tmp/GoogleNet_CIFAR10/beta_influence/google_cifar_beta_train_loss_acc.csv', 'w')
csv_writer1 = csv.writer(f1)

line1_1 = ['beta', 'epoch', 'train loss', 'train acc', 'train time']
csv_writer1.writerow(line1_1)

f2 = open('/home/user/tmp/GoogleNet_CIFAR10/beta_influence/google_cifar_beta_error_test_loss_acc.csv', 'w')
