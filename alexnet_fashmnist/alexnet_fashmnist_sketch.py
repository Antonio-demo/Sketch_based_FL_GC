...
from alexnet_fashmnist_Fed import rand_hashing, countsketch_2
import wandb
...
# f1 = open('/home/user/tmp/GoogleNet_CIFAR10/alexnet_fashmnist/sketch/alexnet_fashmnist_sketch_train_loss_acc.csv', 'w')
...
#
#
# f2 = open('/home/user/tmp/GoogleNet_CIFAR10/alexnet_fashmnist/sketch/alexnet_fashmnist_sketch_test_loss_acc.csv', 'w')
...
conv_weight = conv_weight.reshape(16, 18)

hash_idx, rand_sgn = rand_hashing(18,2)
countsketch_x = countsketch_2(conv_weight, hash_idx, rand_sgn)#16*9

b = torch.ones((16,9)).to(device)

tensor_x = torch.cat((countsketch_x, b), 1).reshape(32,1,3,3)
...
#
# # Save Models
# torch.save(model.state_dict(), "alexnet_fashmnist_sketch.pt")
