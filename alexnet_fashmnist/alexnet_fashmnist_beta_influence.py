...
f1 = open(
	'/home/user/tmp/GoogleNet_CIFAR10/alexnet_fashmnist/beta_influence/alexnet_fashmnist_beta_error_train_loss_acc.csv',
	'w')
...
f2 = open(
	'/home/user/tmp/GoogleNet_CIFAR10/alexnet_fashmnist/beta_influence/alexnet_fashmnist_beta_error_test_loss_acc.csv',
	'w')
...
# Save Models
torch.save(model.state_dict(), "alexnet_fashmnist_beta_influence.pt")
