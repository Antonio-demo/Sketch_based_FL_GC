...
f1 = open('/home/user/tmp/GoogleNet_CIFAR10/alexnet_fashmnist/svd_sketch_error/alexnet_fashmnist_svd_sketch_error_train_loss_acc.csv', 'w')
...
f2 = open('/home/user/tmp/GoogleNet_CIFAR10/alexnet_fashmnist/svd_sketch_error/alexnet_fashmnist_svd_sketch_error_test_loss_acc.csv', 'w')
...
tensor_x_3 = tensor_x_2 + alpha * error_accumulate_3 #32*9
...
# Save Models
torch.save(model.state_dict(), "alexnet_fashmnist_svd.pth")
