...
from models.Fed import FedAvg, rand_hashing, countsketch_2
...
if __name__ == '__main__':
	...
	conv1_weight = w_global['conv1.weight'].reshape(25,30)
	#10*3*5*5
	#print(conv1_weight.shape)

	hash_idx, rand_sgn = rand_hashing(30, 2)
	countsketch_x = countsketch_2(conv1_weight, hash_idx, rand_sgn)
	#print(countsketch_x.shape)#25*15=375
