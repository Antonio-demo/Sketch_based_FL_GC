...
if __name__ == '__main__':
	...
	updated_weight = updated_weight_fc2[:75, :10].reshape(5, 5, 3, 10)
	...
	for iter in tqdm(range(args.epochs)):
		...
		# 将结果保存到 Excel文件
		with pd.ExcelWriter('100_cnn_mnist_ISVD_fedavg_train_results.xlsx') as writer_1:
			results_df.to_excel(writer_1, index=False, sheet_name='Results')
		
		with pd.ExcelWriter('100_cnn_mnist_ISVD_fedavg_test_results.xlsx') as writer_2:
