...
from models.Fed import FedAvg,rand_hashing, countsketch
...
if __name__ == '__main__':
	...
	print(f"layer_input_weight:{layer_input_weight.shape}")
	
	hash_idx, rand_sgn = rand_hashing(2352, 200)
	countsketch_x = countsketch(layer_input_weight, hash_idx, rand_sgn)
	#print(countsketch_x.shape)#200 * 11
	
	
	w_global['layer_input.weight'] = countsketch_x
	#clipgrad = clip_grad(w_glob['layer_input.weight'], 3)
