...
if __name__ == '__main__':
    ...
    results = data_utils.ResultsLog(results_file % 'csv', results_file % 'html')
    gv_acc = []
    ...
    for rounds in range(Args.rounds):
        ...
        results.add(rounds=Args.rounds,clients=Args.num_C,epoch=rounds + 1, train_loss=g_loss,  val_error1=g_acc)
        results.save()
    winsound.PlaySound(r"C:\Users\黄小皮\Desktop\铃声.mp3", winsound.SND_FILENAME)