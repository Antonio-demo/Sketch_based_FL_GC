...
if __name__ == '__main__':
	...
	# 100*2352
	# print(result.shape)
	x = k_svd(result, 50).reshape(50, 2352)
	...
	hash_idx, rand_sgn = rand_hashing(2352, 3)
	...
	for iter in tqdm(range(args.epochs)):
		...
		# 将结果保存到 Excel文件
		with pd.ExcelWriter(f'100_MLP_MNIST_ISVD_sketch_error_0.3_fedavg_train_results.xlsx') as writer_1:
			results_df.to_excel(writer_1, index=False, sheet_name='Results')
		
		with pd.ExcelWriter(f'100_MLP_MNIST_ISVD_sketch_error_0.3_fedavg_test_results.xlsx') as writer_2:
