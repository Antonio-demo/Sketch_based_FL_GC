...
w_global['conv1.0.weight'] = tensor_x_2
...
for epoch in tqdm(range(NUM_EPOCHS)):
	...
	# 将结果保存到 Excel文件
	with pd.ExcelWriter('100_resnet_cifar_ISVD_sketch_fedavg_train_results.xlsx') as writer_1:
		results_df.to_excel(writer_1, index=False, sheet_name='Results')

	with pd.ExcelWriter('100_resnet_cifar_ISVD_sketch_fedavg_test_results.xlsx') as writer_2:
