...
if __name__ == '__main__':
	...
	#print(f"weight_fc2:{weight_fc2.shape}")#(200, 3072)
	# 示例数据
	...
	for iter in tqdm(range(args.epochs)):
		...
		# 将结果保存到 Excel文件
		with pd.ExcelWriter('100_mlp_cifar_ISVD_fedavg_train_results.xlsx') as writer_1:
			results_df.to_excel(writer_1, index=False, sheet_name='Results')
		
		with pd.ExcelWriter('100_mlp_cifar_ISVD_fedavg_test_results.xlsx') as writer_2:
