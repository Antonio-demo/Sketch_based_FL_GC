...
f1 = open('./mnist_resnet_svd_sketch_train_loss_acc.csv', 'w')
csv_writer1 = csv.writer(f1)

f2 = open('./mnist_resnet_svd_sketch_test_loss_acc.csv', 'w')
...
#print(tensor_x_2.shape)#64*1*7*7

# print(b.shape)
w_glob['conv1.weight'] = tensor_x_2
...
for epoch in range(NUM_EPOCHS):
	...
	line2 = [epoch + 1, valid_loss, valid_acc]
