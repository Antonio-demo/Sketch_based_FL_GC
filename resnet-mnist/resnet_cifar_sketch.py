...
conv1_weight = w_global['conv1.0.weight'].reshape(64,27)
...
#print(countsketch_x.shape)#(64, 13)

b = torch.zeros((64,14)).to(DEVICE)
#print(b.shape)#64*1*4*7
tensor_x = torch.cat((countsketch_x,b),1).reshape(64,3,3,3)
#print(conuntsketch_cat_x.shape)#(64,27)
